...
- **[Mastra](https://mastra.ai)** — an agent framework with built-in tools,
  memory, and workflow orchestration.
- **[LangGraph](https://www.langchain.com/langgraph)** — LangGraph agents built with Dawn,
  a meta-framework that discovers agents, tools, and skills automatically via
  `dawn.config.ts`.
