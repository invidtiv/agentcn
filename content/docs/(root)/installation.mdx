---
title: Installation
description: Install an agent recipe into your Eve, Flue, Mastra, or LangGraph (Dawn) project.
---
...
- **LangGraph (Dawn)** — `npx dawn init my-agent` ([docs](https://dawn-ai.dev)).
  Recipes install under the project root alongside `dawn.config.ts`. Dawn is the
  meta-framework that discovers LangGraph agents, tools, and skills automatically.
