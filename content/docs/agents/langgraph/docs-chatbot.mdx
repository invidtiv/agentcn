...
<ComponentSource
  src="registry/langgraph/docs-chatbot/data/functions.json"
  title="data/functions.json"
/>

<ComponentSource
  src="registry/langgraph/docs-chatbot/index.ts"
  title="index.ts"
/>

<ComponentSource
  src="registry/langgraph/docs-chatbot/instructions.md"
  title="instructions.md"
/>

<ComponentSource
  src="registry/langgraph/docs-chatbot/tools/lookup_docs.ts"
