...
<ComponentSource
  src="registry/langgraph/claw/instructions.md"
  title="instructions.md"
/>

<ComponentSource
  src="registry/langgraph/claw/lib/workspace.ts"
  title="lib/workspace.ts"
/>

<ComponentSource
  src="registry/langgraph/claw/skills/workspace/SKILL.md"
  title="skills/workspace/SKILL.md"
/>

<ComponentSource
  src="registry/langgraph/claw/tools/delete_file.ts"
  title="tools/delete_file.ts"
/>

<ComponentSource
  src="registry/langgraph/claw/tools/edit_file.ts"
  title="tools/edit_file.ts"
/>

<ComponentSource
  src="registry/langgraph/claw/tools/grep.ts"
  title="tools/grep.ts"
/>

<ComponentSource
  src="registry/langgraph/claw/tools/list_files.ts"
  title="tools/list_files.ts"
/>

<ComponentSource
  src="registry/langgraph/claw/tools/read_file.ts"
  title="tools/read_file.ts"
/>

<ComponentSource
  src="registry/langgraph/claw/tools/run_shell.ts"
  title="tools/run_shell.ts"
/>

<ComponentSource
  src="registry/langgraph/claw/tools/write_file.ts"
