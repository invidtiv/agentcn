...
<DocsBaseSwitcher base="langgraph" agent="text-to-sql" />
...
```bash
npx shadcn@latest add @agentcn/langgraph/text-to-sql
```
...
<ComponentSource
  src="registry/langgraph/text-to-sql/index.ts"
  title="index.ts"
/>

<ComponentSource
  src="registry/langgraph/text-to-sql/instructions.md"
  title="instructions.md"
/>

<ComponentSource
  src="registry/langgraph/text-to-sql/lib/db.ts"
  title="lib/db.ts"
/>

<ComponentSource
  src="registry/langgraph/text-to-sql/tools/execute-sql.ts"
  title="tools/execute-sql.ts"
/>

<ComponentSource
  src="registry/langgraph/text-to-sql/tools/introspect-database.ts"
