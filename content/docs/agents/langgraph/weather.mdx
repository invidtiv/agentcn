...
<DocsBaseSwitcher base="langgraph" agent="weather" />
...
<ComponentSource src="registry/langgraph/weather/index.ts" title="index.ts" />

<ComponentSource
  src="registry/langgraph/weather/instructions.md"
  title="instructions.md"
/>

<ComponentSource
  src="registry/langgraph/weather/tools/get_weather.ts"
