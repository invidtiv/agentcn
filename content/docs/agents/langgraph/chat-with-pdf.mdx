...
<ComponentSource
  src="registry/langgraph/chat-with-pdf/index.ts"
  title="index.ts"
/>

<ComponentSource
  src="registry/langgraph/chat-with-pdf/instructions.md"
  title="instructions.md"
/>

<ComponentSource
  src="registry/langgraph/chat-with-pdf/lib/vector-store.ts"
  title="lib/vector-store.ts"
/>

<ComponentSource
  src="registry/langgraph/chat-with-pdf/tools/list_documents.ts"
  title="tools/list_documents.ts"
/>

<ComponentSource
  src="registry/langgraph/chat-with-pdf/tools/query_pdf.ts"
