...
<ComponentSource
  src="registry/langgraph/company-knowledge/index.ts"
  title="index.ts"
/>

<ComponentSource
  src="registry/langgraph/company-knowledge/instructions.md"
  title="instructions.md"
/>

<ComponentSource
  src="registry/langgraph/company-knowledge/lib/pii.ts"
  title="lib/pii.ts"
/>

<ComponentSource
  src="registry/langgraph/company-knowledge/lib/vector-store.ts"
  title="lib/vector-store.ts"
/>

<ComponentSource
  src="registry/langgraph/company-knowledge/tools/index_document.ts"
  title="tools/index_document.ts"
/>

<ComponentSource
  src="registry/langgraph/company-knowledge/tools/search_knowledge.ts"
