...
<DocsBaseSwitcher base="langgraph" agent="meeting-notes" />
...
```bash
npx shadcn@latest add @agentcn/langgraph/meeting-notes
```
...
<ComponentSource
  src="registry/langgraph/meeting-notes/index.ts"
  title="index.ts"
/>

<ComponentSource
  src="registry/langgraph/meeting-notes/instructions.md"
  title="instructions.md"
/>

<ComponentSource
  src="registry/langgraph/meeting-notes/tools/get_transcript.ts"
  title="tools/get_transcript.ts"
/>

<ComponentSource
  src="registry/langgraph/meeting-notes/tools/list_meetings.ts"
  title="tools/list_meetings.ts"
/>

<ComponentSource
  src="registry/langgraph/meeting-notes/tools/save_notes.ts"
