...
<DocsBaseSwitcher base="langgraph" agent="docs-expert" />
...
```bash
npx shadcn@latest add @agentcn/langgraph/docs-expert
```
...
<ComponentSource
  src="registry/langgraph/docs-expert/index.ts"
  title="index.ts"
/>

<ComponentSource
  src="registry/langgraph/docs-expert/instructions.md"
  title="instructions.md"
/>

<ComponentSource
  src="registry/langgraph/docs-expert/tools/web_search.ts"
