...
<ComponentSource
  src="registry/langgraph/chat-with-youtube/index.ts"
  title="index.ts"
/>

<ComponentSource
  src="registry/langgraph/chat-with-youtube/instructions.md"
  title="instructions.md"
/>

<ComponentSource
  src="registry/langgraph/chat-with-youtube/lib/youtube-utils.ts"
  title="lib/youtube-utils.ts"
/>

<ComponentSource
  src="registry/langgraph/chat-with-youtube/tools/youtube-metadata.ts"
  title="tools/youtube-metadata.ts"
/>

<ComponentSource
  src="registry/langgraph/chat-with-youtube/tools/youtube-transcript.ts"
