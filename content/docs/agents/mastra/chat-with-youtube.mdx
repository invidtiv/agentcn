...
<ComponentSource
  src="registry/mastra/chat-with-youtube/lib/brightdata.ts"
  title="lib/brightdata.ts"
/>

<ComponentSource
  src="registry/mastra/chat-with-youtube/tools/video_metadata.ts"
  title="tools/video_metadata.ts"
/>

<ComponentSource
  src="registry/mastra/chat-with-youtube/tools/get_transcript.ts"
