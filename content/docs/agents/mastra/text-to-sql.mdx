...
<ComponentSource
  src="registry/mastra/text-to-sql/tools/introspect_schema.ts"
  title="tools/introspect_schema.ts"
/>

<ComponentSource
  src="registry/mastra/text-to-sql/tools/run_query.ts"
  title="tools/run_query.ts"
/>
