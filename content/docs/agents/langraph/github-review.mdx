...
<DocsBaseSwitcher base="langraph" agent="github-review" />
...
```bash
npx shadcn@latest add @agentcn/langraph/github-review
```
...
<ComponentSource
  src="registry/langraph/github-review/index.ts"
  title="index.ts"
/>

<ComponentSource
  src="registry/langraph/github-review/instructions.md"
  title="instructions.md"
/>

<ComponentSource
  src="registry/langraph/github-review/tools/fetch_pr.ts"
  title="tools/fetch_pr.ts"
/>

<ComponentSource
  src="registry/langraph/github-review/tools/get_file_content.ts"
  title="tools/get_file_content.ts"
/>

<ComponentSource
  src="registry/langraph/github-review/tools/get_pr_files.ts"
  title="tools/get_pr_files.ts"
/>

<ComponentSource
  src="registry/langraph/github-review/tools/parse_github_url.ts"
