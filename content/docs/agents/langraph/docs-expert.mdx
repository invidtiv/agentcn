...
<DocsBaseSwitcher base="langraph" agent="docs-expert" />
...
```bash
npx shadcn@latest add @agentcn/langraph/docs-expert
```
...
<ComponentSource
  src="registry/langraph/docs-expert/index.ts"
  title="index.ts"
/>

<ComponentSource
  src="registry/langraph/docs-expert/instructions.md"
  title="instructions.md"
/>

<ComponentSource
  src="registry/langraph/docs-expert/tools/web_search.ts"
