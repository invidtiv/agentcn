...
<DocsBaseSwitcher base="langraph" agent="extract-design-md" />
...
```bash
npx shadcn@latest add @agentcn/langraph/extract-design-md
```
...
<ComponentSource
  src="registry/langraph/extract-design-md/index.ts"
  title="index.ts"
/>

<ComponentSource
  src="registry/langraph/extract-design-md/instructions.md"
  title="instructions.md"
/>

<ComponentSource
  src="registry/langraph/extract-design-md/lib/compose.ts"
  title="lib/compose.ts"
/>

<ComponentSource
  src="registry/langraph/extract-design-md/lib/derive-tokens.ts"
  title="lib/derive-tokens.ts"
/>

<ComponentSource
  src="registry/langraph/extract-design-md/lib/design-md.ts"
  title="lib/design-md.ts"
/>

<ComponentSource
  src="registry/langraph/extract-design-md/tools/compose_design_md.ts"
