...
<DocsBaseSwitcher base="langraph" agent="feedback-summary" />
...
```bash
npx shadcn@latest add @agentcn/langraph/feedback-summary
```
...
<ComponentSource
  src="registry/langraph/feedback-summary/index.ts"
  title="index.ts"
/>

<ComponentSource
  src="registry/langraph/feedback-summary/instructions.md"
  title="instructions.md"
/>

<ComponentSource
  src="registry/langraph/feedback-summary/tools/get_feedback.ts"
