...
<DocsBaseSwitcher base="langraph" agent="chat-with-youtube" />
...
```bash
npx shadcn@latest add @agentcn/langraph/chat-with-youtube
```
...
<ComponentSource
  src="registry/langraph/chat-with-youtube/index.ts"
  title="index.ts"
/>

<ComponentSource
  src="registry/langraph/chat-with-youtube/instructions.md"
  title="instructions.md"
/>

<ComponentSource
  src="registry/langraph/chat-with-youtube/lib/youtube-utils.ts"
  title="lib/youtube-utils.ts"
/>

<ComponentSource
  src="registry/langraph/chat-with-youtube/tools/youtube-metadata.ts"
  title="tools/youtube-metadata.ts"
/>

<ComponentSource
  src="registry/langraph/chat-with-youtube/tools/youtube-transcript.ts"
