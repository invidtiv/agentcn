...
<DocsBaseSwitcher base="langraph" agent="slack-agent" />
...
```bash
npx shadcn@latest add @agentcn/langraph/slack-agent
```
...
<ComponentSource
  src="registry/langraph/slack-agent/index.ts"
  title="index.ts"
/>

<ComponentSource
  src="registry/langraph/slack-agent/instructions.md"
  title="instructions.md"
/>

<ComponentSource
  src="registry/langraph/slack-agent/tools/post_message.ts"
