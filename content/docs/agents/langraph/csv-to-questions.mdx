...
<DocsBaseSwitcher base="langraph" agent="csv-to-questions" />
...
```bash
npx shadcn@latest add @agentcn/langraph/csv-to-questions
```
...
<ComponentSource
  src="registry/langraph/csv-to-questions/index.ts"
  title="index.ts"
/>

<ComponentSource
  src="registry/langraph/csv-to-questions/instructions.md"
  title="instructions.md"
/>

<ComponentSource
  src="registry/langraph/csv-to-questions/tools/fetch_csv.ts"
  title="tools/fetch_csv.ts"
/>

<ComponentSource
  src="registry/langraph/csv-to-questions/tools/generate_questions.ts"
