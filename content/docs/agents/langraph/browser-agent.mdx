...
<DocsBaseSwitcher base="langraph" agent="browser-agent" />
...
```bash
npx shadcn@latest add @agentcn/langraph/browser-agent
```
...
<ComponentSource
  src="registry/langraph/browser-agent/index.ts"
  title="index.ts"
/>

<ComponentSource
  src="registry/langraph/browser-agent/instructions.md"
