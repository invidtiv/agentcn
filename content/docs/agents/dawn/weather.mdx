...
<DocsBaseSwitcher base="dawn" agent="weather" />
...
```bash
npx shadcn@latest add @agentcn/dawn/weather
```
...
<ComponentSource src="registry/dawn/weather/index.ts" title="index.ts" />

<ComponentSource
  src="registry/dawn/weather/instructions.md"
  title="instructions.md"
/>

<ComponentSource
  src="registry/dawn/weather/tools/get_weather.ts"
