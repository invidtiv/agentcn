...
<DocsBaseSwitcher base="dawn" agent="google-sheets" />
...
```bash
npx shadcn@latest add @agentcn/dawn/google-sheets
```
...
<ComponentSource src="registry/dawn/google-sheets/index.ts" title="index.ts" />

<ComponentSource
  src="registry/dawn/google-sheets/instructions.md"
  title="instructions.md"
/>

<ComponentSource
  src="registry/dawn/google-sheets/tools/read_range.ts"
  title="tools/read_range.ts"
/>

<ComponentSource
  src="registry/dawn/google-sheets/tools/update_range.ts"
