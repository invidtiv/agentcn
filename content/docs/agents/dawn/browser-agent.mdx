...
<DocsBaseSwitcher base="dawn" agent="browser-agent" />
...
```bash
npx shadcn@latest add @agentcn/dawn/browser-agent
```
...
<ComponentSource src="registry/dawn/browser-agent/index.ts" title="index.ts" />

<ComponentSource
  src="registry/dawn/browser-agent/instructions.md"
