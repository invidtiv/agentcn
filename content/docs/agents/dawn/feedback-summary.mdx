...
<DocsBaseSwitcher base="dawn" agent="feedback-summary" />
...
```bash
npx shadcn@latest add @agentcn/dawn/feedback-summary
```
...
<ComponentSource
  src="registry/dawn/feedback-summary/index.ts"
  title="index.ts"
/>

<ComponentSource
  src="registry/dawn/feedback-summary/instructions.md"
  title="instructions.md"
/>

<ComponentSource
  src="registry/dawn/feedback-summary/tools/get_feedback.ts"
